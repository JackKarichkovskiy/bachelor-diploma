...
public class SimulationClass {
	...
	private List<Service> constructServices(){
		List<Service> services =  new ArrayList<Service>() {
			{
				add(new Service("Video buffering1", 100, 100, new UniformGenerator(0.004, 0.006666)));//150-250
				...
				add(new Service("Weather service", 10, 30, new UniformGenerator(0.0111, 0.02)));//50-90
